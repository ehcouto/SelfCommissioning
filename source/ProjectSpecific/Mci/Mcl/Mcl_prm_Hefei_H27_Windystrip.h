/**
 *  @file        Mcl_prm_Hefei_H27.h
 *  @brief       DTC Loop Parameters for 3-phase motors.
 *
 *               ==== AUTOMATIC GENERATED FILE! DO NOT TOUCH IT, USE EXCEL MACRO! ====
 *
 *  @details     This module defines all parameters of the DTC control loop for 3-phase motors. Created in 26/9/2018 11:8 
 *               Setting File Parameters for sBPM Hefei H27
 *               Generated from https://docs.google.com/a/whirlpool.com/spreadsheets/d/1ghiIVd271y5E4K5E_y-DhLaIYTkhHQSX3lrDPTb6XBg/edit
