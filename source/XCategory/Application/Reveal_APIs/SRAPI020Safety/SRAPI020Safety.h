...
//=====================================================================================================================
	...
	/* API020_USE_RX_ARRAY must be defined as DISABLED */
	#ifndef API020_USE_RX_ARRAY
		#define API020_USE_RX_ARRAY	DISABLED
	/* API020_USE_RX_ARRAY is defined */
	#elif (API020_USE_RX_ARRAY != DISABLED)
		#error API020_USE_RX_ARRAY must be defined as DISABLED
	#endif
#else /* API020_NUMBER_OF_RX_CHANNELS > 0 */
	/* API020_USE_RX_ARRAY can be defined as ENABLED or DISABLED */
	#ifndef API020_USE_RX_ARRAY
		#define API020_USE_RX_ARRAY	DISABLED
	#elif API020_USE_RX_ARRAY != ENABLED && API020_USE_RX_ARRAY != DISABLED
		#error API020_USE_RX_ARRAY must be defined as ENABLED or DISABLED
	#endif
#endif
...
typedef struct API020_RX_CONFIG_STRUCT
{
	...
	//! Value that will be inserted into the buffer when the sequence id is invalid.
    void* Error_Value;
	#endif
    ...
    //! Range: 0 or 1 = array has been disabled
	//! Range: 2 to 255
	//! Resolution: 1 = 1 element in a buffer
	uint8 Array_Size;
	#endif
