 ...
 *          #define SYSTEM_ACU_EXPANSION_HANDLING   DISABLED
 *          #define SYSTEM_HMI_EXPANSION_HANDLING   DISABLED
 *          #define SYSTEM_EXPANSION_HANDLING       ENABLED         // this enables the API012EXP_FEATURE
 *
 *      ACU Expansion
 ...
 *          #define SYSTEM_HMI_EXPANSION_HANDLING   DISABLED
 *          #define SYSTEM_EXPANSION_HANDLING       DISABLED
 *          #define SFUPDATER_ACU_SECTION_ID        SF_ID_ACU_EXP_1 // can be other SettingFile ID from SF_ID_TYPE
 *
 ...
 *          #define SYSTEM_EXPANSION_HANDLING       DISABLED
 *          #define SFUPDATER_HMI_SECTION_ID        SF_ID_HMI_EXP_1 // can be other SettingFile ID from SF_ID_TYPE
 *
